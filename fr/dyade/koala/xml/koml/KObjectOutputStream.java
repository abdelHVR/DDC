 ...
 * $Id: KObjectOutputStream.java,v 1.1 1998/11/29 15:31:16 plehegar Exp $
 */
...
class KObjectOutputStream extends ObjectOutputStream {
     ...
     */
    ClassDescription[] getAllClassDescription() 
	    throws IOException, ClassNotFoundException {
	ClassDescription[] classes = new ClassDescription[v.size()];

	InputStream input = null;
	ByteInputOutputStream in = new ByteInputOutputStream();       

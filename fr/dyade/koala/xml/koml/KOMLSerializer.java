 ...
 * KOMLSerializer.java
 * $Id: KOMLSerializer.java,v 1.14 1998/11/10 23:29:55 plehegar Exp $
 */
...
public class KOMLSerializer 
	...
	ClassDescription[] classes = ostream.getAllClassDescription();
	...
	try {
		...
		out._writeClassDescription(classes[i]);
	    }
	    out.writeEndClasses();
